...
const User currentUser = User(
  name: 'Seyon Anko',
  imageUrl:
      'https://media-exp1.licdn.com/dms/image/C5603AQEWQz61wKcCWQ/profile-displayphoto-shrink_200_200/0/1617757251525?e=1623888000&v=beta&t=rb4pVIBNucf2zsfOGCurKQDZQeTN5YglUlEOctQtKbw',
);
...
final List<Post> posts = [
  const Post(
    user: currentUser,
    caption: 'Beautifull Nature',
    timeAgo: '58m',
    imageUrl: 'https://i.insider.com/5efe10533f73703c02240358?width=700',
    likes: 1202,
    comments: 184,
    shares: 96,
  ),
